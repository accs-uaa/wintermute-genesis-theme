 ...
 * Wintermute
 *
 * This page modifies the search results page for the Wintermute theme.
 *
...
function sk_do_search_loop() {
	...
	foreach ( $post_types as $post_type ) {
		...
		if ( $query->have_posts() ) {
			echo '<h3>Search results for "'. $s .'"</h3>
				&nbsp;';
				// remove post info.
...
// Output search results to new page
...
function sp_excerpt_length( $length ) {
	return 100; // pull first 20 words.
}
genesis();